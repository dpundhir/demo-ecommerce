...
<!-- site metas -->
<title>Wood Furniture Shop</title>
<!-- bootstrap css -->
		...
		<div class="container-fluid">
			<div class="row">
			    <div class="col-sm-12 col-lg-3">
					<div class="logo"><h1 style="font-family: 'Goblin One', cursive; font-size: 45px;">FURN</h1></div>
			    </div>
                    ...
                    <nav class="navbar navbar-expand-lg ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav mr-auto">
                               ...
                               <li class="#" href="#">
      	                        <a class="nav-link" href="furniture.html">Furnitures</a></li>
			    ...
			    <div class="col-sm-8 col-lg-4">
                  ...
                  <div class="middle_main">
                     <div class="menu_main">
                        <a class="nav-link" href="#"><i class="fa fa-fw fa-user"></i> Login / Register</a>
                     </div>
                  </div>
                 </div>
			    </div>
...
<!-- about section start -->
   <div class="layout_padding about_section ">
		<div class="container">
			<h1 class="about_title">About <span style="background-color: #900C3F; color: #fff; padding: 0px 5px;">Us</span></h1>
			<div class="about_bg">
				<div class="row">
					<div class="col-md-8">
					...
					<div class="col-md-4">
						<div class="table_img"><img src="images/img-2.png"></div>
					</div>
				</div>
			</div>
		</div>
    ...
    <div class="container">
           <div id="my_carousel" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                ...
                <h1 class="testi_monila_text">Testi <span style="background-color: #900C3F; color: #fff; padding: 0px 5px;">Monial</span></h1>
  ...
  <!-- testi monial section end -->
			...
			<div class="row">
			    <div class="col-md-12">
				   <h2 class="useful_text">Address</h2>
                     <ul class="location">
			    			<li><img src="images/map-icon.png">Bangalore,India</li>
			    			<li><img src="images/call-icon.png">>+91 999999999</li>
			    			<li><img src="images/email-icon.png">darklaunch@gmail.com</li>
	...
	<div class="copyright">
		<div class="container">
			<p class="copyright_text">Made with Love &#10084; by Team Dark Launch</p>
		</div>
	</div>
